...
-- Push and in-app chat notifications should identify the person who wrote the
-- message. The recipient already has permission to read that chat, so exposing
-- the active sender's display name in their notification is appropriate and
-- gives the inbox the familiar, useful WhatsApp-style cue.
